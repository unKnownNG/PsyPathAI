    ...
    subPaths: [
      {
        ...
        phases: [
          ...
          { id: "fe-p2", title: "Framework Mastery", description: "Modern frontend frameworks", topics: [
            { id: "fe-t4", name: "React", description: "Component-based UI library", timeEstimate: "4 weeks", difficulty: "Intermediate" },
            { id: "fe-t5", name: "TypeScript", description: "Type-safe JavaScript", timeEstimate: "2 weeks", difficulty: "Intermediate" },
            { id: "fe-t6", name: "Next", description: "React meta-framework", timeEstimate: "3 weeks", difficulty: "Intermediate" },
          ]},
