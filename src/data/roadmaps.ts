        ...
        phases: [
          {
            ...
            topics: [
              { id: "fe-t1", name: "HTML5 & Semantic Markup", description: "Learn the building blocks of the web", timeEstimate: "2 weeks", difficulty: "Beginner", details: "Master semantic HTML5 elements, forms, accessibility attributes, and SEO-friendly markup patterns.", resources: [{ title: "MDN HTML Guide", url: "#", type: "docs" }, { title: "HTML Crash Course", url: "#", type: "video" }] },
              { id: "fe-t2", name: "CSS3 & Responsive Design", description: "Style and layout mastery", timeEstimate: "3 weeks", difficulty: "Beginner", details: "Flexbox, Grid, animations, media queries, and mobile-first design principles.", resources: [{ title: "CSS Tricks Flexbox", url: "#", type: "article" }, { title: "Responsive Design Course", url: "#", type: "course" }] },
              { id: "fe-t3", name: "JavaScript Fundamentals", description: "Programming the web", timeEstimate: "4 weeks", difficulty: "Beginner", details: "Variables, functions, DOM manipulation, events, async/await, and ES6+ features.", resources: [{ title: "JavaScript.info", url: "#", type: "docs" }, { title: "JS Fundamentals", url: "#", type: "course" }] },
            ],
          },
          {
            id: "fe-p2", title: "Framework Mastery", description: "Modern frontend frameworks",
            topics: [
              { id: "fe-t4", name: "React.js", description: "Component-based UI library", timeEstimate: "4 weeks", difficulty: "Intermediate", details: "Components, hooks, state management, routing, and the React ecosystem.", resources: [{ title: "React Docs", url: "#", type: "docs" }, { title: "React Course", url: "#", type: "course" }] },
              { id: "fe-t5", name: "TypeScript", description: "Type-safe JavaScript", timeEstimate: "2 weeks", difficulty: "Intermediate", details: "Type system, interfaces, generics, and integration with React.", resources: [{ title: "TypeScript Handbook", url: "#", type: "docs" }, { title: "TS with React", url: "#", type: "video" }] },
              { id: "fe-t6", name: "Next.js", description: "React meta-framework", timeEstimate: "3 weeks", difficulty: "Intermediate", details: "SSR, SSG, API routes, App Router, and full-stack React development.", resources: [{ title: "Next.js Docs", url: "#", type: "docs" }, { title: "Next.js Tutorial", url: "#", type: "course" }] },
            ],
          },
          {
            id: "fe-p3", title: "Advanced & Professional", description: "Production-ready skills",
            topics: [
              { id: "fe-t7", name: "Testing & Quality", description: "Ensure code reliability", timeEstimate: "2 weeks", difficulty: "Advanced", details: "Jest, React Testing Library, Cypress, and CI/CD integration.", resources: [{ title: "Testing Library Docs", url: "#", type: "docs" }, { title: "Testing React Apps", url: "#", type: "video" }] },
              { id: "fe-t8", name: "Performance Optimization", description: "Fast web experiences", timeEstimate: "2 weeks", difficulty: "Advanced", details: "Code splitting, lazy loading, Web Vitals, and profiling tools.", resources: [{ title: "Web.dev Performance", url: "#", type: "article" }, { title: "React Performance", url: "#", type: "video" }] },
            ],
          },
        ],
      },
        ...
        phases: [
          {
            ...
            topics: [
              { id: "be-t1", name: "Node.js & Express", description: "JavaScript on the server", timeEstimate: "3 weeks", difficulty: "Beginner", details: "HTTP servers, middleware, routing, and REST API design with Express.js.", resources: [{ title: "Node.js Docs", url: "#", type: "docs" }, { title: "Express Crash Course", url: "#", type: "video" }] },
              { id: "be-t2", name: "Databases (SQL & NoSQL)", description: "Data persistence", timeEstimate: "3 weeks", difficulty: "Intermediate", details: "PostgreSQL, MongoDB, ORMs, query optimization, and data modeling.", resources: [{ title: "PostgreSQL Tutorial", url: "#", type: "course" }, { title: "MongoDB University", url: "#", type: "course" }] },
              { id: "be-t3", name: "Authentication & Authorization", description: "Secure user systems", timeEstimate: "2 weeks", difficulty: "Intermediate", details: "JWT, OAuth2, session management, and role-based access control.", resources: [{ title: "Auth0 Guides", url: "#", type: "docs" }, { title: "JWT Explained", url: "#", type: "video" }] },
            ],
          },
          {
            id: "be-p2", title: "Advanced Backend", description: "Scalable architecture",
            topics: [
              { id: "be-t4", name: "API Design & GraphQL", description: "Modern API patterns", timeEstimate: "3 weeks", difficulty: "Intermediate", details: "REST best practices, GraphQL schemas, resolvers, and API versioning.", resources: [{ title: "GraphQL Docs", url: "#", type: "docs" }, { title: "API Design Guide", url: "#", type: "article" }] },
              { id: "be-t5", name: "Caching & Message Queues", description: "Performance at scale", timeEstimate: "2 weeks", difficulty: "Advanced", details: "Redis, RabbitMQ, pub/sub patterns, and distributed caching strategies.", resources: [{ title: "Redis University", url: "#", type: "course" }, { title: "Message Queues 101", url: "#", type: "video" }] },
            ],
          },
        ],
      },
        ...
        phases: [
          {
            ...
            topics: [
              { id: "fs-t1", name: "Full Stack Architecture", description: "Connecting all pieces", timeEstimate: "3 weeks", difficulty: "Intermediate", details: "Monorepo setup, API integration, state management across the stack.", resources: [{ title: "Full Stack Open", url: "#", type: "course" }, { title: "Architecture Patterns", url: "#", type: "article" }] },
              { id: "fs-t2", name: "DevOps for Full Stack", description: "Deployment & CI/CD", timeEstimate: "2 weeks", difficulty: "Advanced", details: "Docker, Vercel/AWS deployment, GitHub Actions, and monitoring.", resources: [{ title: "Docker Docs", url: "#", type: "docs" }, { title: "CI/CD Pipeline", url: "#", type: "video" }] },
            ],
          },
        ],
      },
