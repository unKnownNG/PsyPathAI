...
const mbtiPathAffinity: Record<string, { slug: string; weight: number }[]> = {
  INTJ: [
...
const hollandBoost: Record<string, string[]> = {
...
const interestBoost: Record<string, string[]> = {
  // Tech interests
...
// ── Goal modifiers ──────────────────────────────────────────
const goalBoost: Record<string, { slugs: string[]; weight: number }> = {
  "Get a Job": {
...
export function getCareerAlignment(
  mbtiType: string,
  hollandCode: string,
  goal: string,
  interests: string[] = []
