 ...
 */
export function registerProgressTools(server) {
    server.tool("get_progress_context", "Returns a progress summary for a student on a specific career path. Shows completed vs remaining topics, current phase, percentage completion, and estimated time to finish. Until a database is connected, it accepts completed topic IDs directly as input.", {
