...
export function registerCareerTools(server) {
    ...
    server.tool("get_career_alignment", "Returns the top 5 ranked career paths for a student based on their MBTI type, Holland code, career goal, and personal interests/hobbies. Each recommendation includes an alignment score (0-100) and detailed reasoning. Covers 38 career paths including non-CS fields like product management, UX research, technical writing, quant finance, embedded systems, robotics, and AI ethics.", {
        ...
        const recommendations = getCareerAlignment(mbtiType.toUpperCase(), hollandCode.toUpperCase(), goal, interests);
        const result = {
    ...
    // ── get_milestone_plan ────────────────────────────────────
    server.tool("get_milestone_plan", "Generates a week-by-week milestone plan for a specific career path, adjusted to the student's available hours per week. Includes phases, topics, estimated durations, and checkpoint goals.", {
